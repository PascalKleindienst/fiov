...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white font-mono dark:bg-zinc-800">
        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 !p-0 dark:border-zinc-700">
            <flux:sidebar.toggle class="lg:hidden" icon="x-mark" />

            <a href="{{ route('dashboard') }}" class="me-5 flex items-center space-x-2 p-4 rtl:space-x-reverse" wire:navigate>
                <x-app-logo />
            </a>
